 ...
 * @version 1.0
 */
public  class RunnableClusterQueryInsert extends RunnableQueryInsertBasic implements Runnable, RunnableQueryInsertInterface {
	...
	public RunnableClusterQueryInsert() {
		try {
